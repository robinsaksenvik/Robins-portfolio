...
function HeroSection() {
  return (
    <section className="relative overflow-hidden rounded-2xl border-[3px] border-foreground bg-gradient-to-b from-secondary via-background to-secondary p-10 shadow-[8px_8px_0_0_hsl(var(--foreground)/0.65)] z-10">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
        {quickLinks.map((link) => (
          <Link
            key={link.label}
            to={link.to}
            className="pressable group flex items-center justify-between gap-4 rounded-xl border-[3px] border-foreground bg-secondary px-5 py-4 font-heading font-semibold text-sm uppercase tracking-[0.2em] relative z-10"
          >
            {link.label}
  ...
  return (
    <section className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <Link
          to="/projects"
          className="pressable relative flex items-center gap-2 rounded-md border-[3px] border-foreground bg-background px-4 py-2 text-sm font-medium uppercase tracking-[0.18em]"
        >
          View all projects
...
function RetroIllustration() {
  return (
    <div className="relative aspect-square w-full rounded-3xl border-[3px] border-foreground bg-background p-6 shadow-[6px_6px_0_0_hsl(var(--foreground)/0.65)] z-10">
